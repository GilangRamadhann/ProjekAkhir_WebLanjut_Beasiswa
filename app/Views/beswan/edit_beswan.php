                ...
                <div class="container-fluid">
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <div class="container-xl px-4 mt-4">
                            ...
                            <h3><?= $title ?></h3>
                            <hr class="mt-0 mb-4">
                            <form action="<?= base_url('/perbaru_profil') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <input type="hidden" class="form-control" name="id_user" value="<?= $userId ?>">
                                    <input type="hidden" class="form-control" name="id" value="<?= $beswan_data[0]->id ?>">
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card mb-4 mb-xl-0">
                                            ...
                                            <div class="card-body text-center">
                                                ...
                                                <div class="text-center">
                                                    <img src="<?= $beswan_data[0]->foto ?? base_url('assets/img/cap.png') ?>" alt="foto" class="img-account-profile rounded-circle mb-2" width="230px">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="nama" type="text" name="nama" value="<?= $beswan_data[0]->nama ?>">
                                                </div>

                                                <!-- Form Group (email address)-->
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="deskripsi">NPM</label>
                                                    <input class="form-control" id="npm" type="text" name="npm" value="<?= $beswan_data[0]->npm ?>">
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="akt" type="number" name="akt" value="<?= $beswan_data[0]->akt ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="nomor">Agama</label>
                                                    <input class="form-control" id="agama" type="text" name="agama" value="<?= $beswan_data[0]->agama ?>"> 
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="nomor">Tanggal Lahir</label>
                                                    <input class="form-control" id="tgl_lahir" type="date" name="tgl_lahir" value="<?= $beswan_data[0]->tgl_lahir ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="nomor">Nomor Telepon</label>
                                                    <input class="form-control" id="nomor" type="text" name="no_telp" value="<?= $beswan_data[0]->no_telp ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="add">Alamat</label>
                                                    <textarea class="form-control" name="alamat" id="alamat" cols="10" rows="2"><?= $beswan_data[0]->alamat ?></textarea>
                                                </div>
