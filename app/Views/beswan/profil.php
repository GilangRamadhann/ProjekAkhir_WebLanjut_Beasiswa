                            ...
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0 pict">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <img src="<?php foreach ($beswan as $item) : ?>
                                        <?= $item->foto ?? base_url('assets/images/cap.png'); ?> 
                                    ...
                                    <div class="card-body">
                                        <div style="text-align: right;">
                                            <div>
                                                ...
                                                if ($check == 0) {
                                                ?>
                                                    <a href="<?= base_url('/tambah_profil') ?>" class="btn btn-primary btn-sm">Tambah</a>
                                                <?php
                                                } else if ($check == 1) {
                                                ?>
                                                    <a href="<?= base_url('/edit_profil') ?>" class="btn btn-warning btn-sm">Ubah</a>
                                                <?php
                                                }
                                                ?>
                                            </div>
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1"><b>Tahun Masuk Universitas</b></label>
                                                <p><?php foreach ($beswan as $item) : ?>
                                                        <?= $item->akt ?>
                                                    <?php endforeach; ?></p>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1"><b>Agama</b></label>
                                                <p><?php foreach ($beswan as $item) : ?>
                                                        <?= $item->agama ?>
                                                    <?php endforeach; ?></p>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label class="small mb-1"><b>Tanggal Lahir</b></label>
                                                <p><?php foreach ($beswan as $item) : ?>
                                                        <?= $item->tgl_lahir ?>
                                                    <?php endforeach; ?></p>
                                            </div>
