            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 mb-1 text-gray-800">Program Beasiswa</h1>
                    </div>
                  
                    <?php for($i=1;$i<=count($program);$i++):?>
                        <?php if($i%3==1):?>
                    <div class="row">
                        <?php endif;?>
                        <div class="col-lg-4 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><?= $program[$i-1]['program_nama']?></h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;height:20rem" src="<?= $program[$i-1]['logo']?>" alt="foto">
                                    </div>
                                    <p><?= $program[$i-1]['deskripsi']?></p>
                                    <a target="_blank" rel="nofollow" href="<?= base_url('lihat_program/'.$program[$i-1]['id'])?>">Selengkapnya &rarr;</a>
                                </div>
                            </div>
                        </div>
