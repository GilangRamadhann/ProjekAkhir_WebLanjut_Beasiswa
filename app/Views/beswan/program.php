                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Nama Beasiswa</h6>
                                </div>
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="#" alt="foto">
                                    </div>
                                    <p>DESKRIPSI</p>
                                    <a target="_blank" rel="nofollow" href="<?= base_url('/lihat_program')?>">Selengkapnya &rarr;</a>
                                </div>
                            </div>
                        </div>
                    </div>
