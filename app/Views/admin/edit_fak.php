                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('/datafak/' . $fakultas['id']) ?>" enctype="multipart/form-data">
                                            <input type="hidden" name="_method" value="PUT">
                                            <?= csrf_field() ?>
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputBes">Fakultas</label>
                                                <input class="form-control" id="inputBes" type="text" placeholder="Masukan Nama Fakultas" name="fakultas" value="<?= $fakultas['fakultas'] ?>">
                                            </div>
                                            <!-- Save changes button-->
                                            <div class="text-right">
                                                <a href="<?= base_url('/datafak') ?>" type="button" class="btn btn-warning btn-sm">Kembali</a>
