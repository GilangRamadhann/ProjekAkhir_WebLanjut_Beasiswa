                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('/datauniv/' . $universitas['id']) ?>" enctype="multipart/form-data">
                                            <input type="hidden" name="_method" value="PUT">
                                            <?= csrf_field() ?>
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputBes">Universitas</label>
                                                <input class="form-control" id="inputBes" type="text" placeholder="Masukan Nama Universitas" name="universitas" value="<?= $universitas['universitas'] ?>">
                                            </div>
                                            <!-- Save changes button-->
                                            <div class="text-right">
                                                <a href="<?= base_url('/datauniv') ?>" type="button" class="btn btn-warning btn-sm">Kembali</a>
