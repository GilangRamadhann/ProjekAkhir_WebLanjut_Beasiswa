                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('/datauniv/store') ?>" enctype="multipart/form-data">
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputBes">Universitas</label>
                                                <input class="form-control" id="inputBes" type="text" placeholder="Masukan Nama Universitas" name="universitas">
                                            </div>
                                            <!-- Save changes button-->
