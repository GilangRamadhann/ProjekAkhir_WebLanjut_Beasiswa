                        ...
                        <div class="row">
                            <div class="col-xl-8">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('/datalokasi/' . $lokasi['id']) ?>" enctype="multipart/form-data">
                                            <input type="hidden" name="_method" value="PUT">
                                            <?= csrf_field() ?>
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputBes">Kota</label>
                                                <input class="form-control" id="inputBes" type="text" placeholder="Masukan Nama Kota" name="kota" value="<?= $lokasi['kota'] ?>">
                                            </div>
                                            <!-- Save changes button-->
