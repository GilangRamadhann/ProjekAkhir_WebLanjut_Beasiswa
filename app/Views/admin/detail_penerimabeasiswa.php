                            ...
                            <div class="card mb-4 acc">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="mb-3">
                                            <label class="small mb-1">NPM</label>
                                            <p><b>2117051081</b></p>
                                        </div>

                                        <div class="mb-3">
                                            <label class="small mb-1">Jurusan</label>
                                            <p><b>Ilmu Komputer</b></p>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="small mb-1">Universitas</label>
                                            <p><b>Universitas Lampung</b></p>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <p><b>gilangramadhan@gmail.com</b></p>
                                        </div>

                                        <div class="mb-3">
                                            <label class="small mb-1">Alamat Lengkap</label>
                                            <p><b>Kemiling, Bandar Lampung</b></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
