                ...
                <div class="container-fluid">
                    ...
                    <div class="container-xl px-4 mt-4">
                        ...
                        <div class="container-xl px-4 mt-4">
                            ...
                            <h3><?= $title ?></h3>
                            <hr class="mt-0 mb-4">
                            <form action="<?= base_url('/perbaru_profile') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                <div class="row">
                                    <input type="hidden" class="form-control" name="id_user" value="<?= $userId ?>">
                                    <input type="hidden" class="form-control" name="id" value="<?= $donatur_data[0]->id ?>">
                                    <div class="col-xl-4">
                                        ...
                                        <div class="card mb-4 mb-xl-0">
                                            ...
                                            <div class="card-body text-center">
                                                <div class="text-center">
                                                    <img src="<?= $donatur_data[0]->logo ?? base_url('assets/img/cap.png') ?>" alt="foto" class="img-account-profile rounded-circle mb-2" width="230px">
                                    ...
                                    <div class="col-xl-8">
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <!-- Form Group (username)-->
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="nama">Nama Organisasi</label>
                                                    <input class="form-control" id="nama" type="text" name="nama" value="<?= $donatur_data[0]->nama ?>">
                                                </div>

                                                <!-- Form Group (email address)-->
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="deskripsi">Deskripsi</label>
                                                    <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10"><?= $donatur_data[0]->deskripsi ?></textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="nomor">Nomor Telepon</label>
                                                    <input class="form-control" id="nomor" type="text" name="no_telp" value="<?= $donatur_data[0]->no_telp ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="add">Alamat</label>
                                                    <textarea class="form-control" name="alamat" id="alamat" cols="10" rows="2"><?= $donatur_data[0]->alamat ?></textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="kota">Kota</label>
                                                    <select class="form-control" name="id_lokasi" value="">
                                                        <option selected disabled>Pilih Kota Domisili</option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="ig" type="text" name="instagram" value="<?= $donatur_data[0]->instagram ?>">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="small mb-1" for="fc">Facebook</label>
                                                    <input class="form-control" id="fc" type="text" name="facebook" value="<?= $donatur_data[0]->facebook ?>">
                                                </div>
                                                <!-- Save changes button-->
